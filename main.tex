...
\begin{document}
\include{metadata} % Variables, \hypersetup, etc.

%======================================================================
%	Title Page (Abstract and Table of Contents)
%======================================================================

\include{title} % Titelpage, Abstract 
% Table of Contents
% Glossary
...
\include{Text/01.Introduction}
\include{Text/02.Fundamentals}
\include{Text/03.Implementation}
\include{Text/04.Results}
\include{Text/05.Evaluation}
\include{Text/06.Summary_Outlook}
